                  ...
                  <div key={index} className="flex items-center justify-between p-3 bg-white/5 rounded-xl">
                    <div className="flex items-center">
                      ...
                      <div className="ml-3">
                        ...
                        <div className="text-white/60 text-sm">{app.category}</div>
                      </div>
                    </div>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
              ...
              <div className="space-y-4">
                <div className="p-4 bg-white/5 rounded-xl">
                  ...
                  <p className="text-white/70 text-sm">Take a 20-second break every 20 minutes to look at something 20 feet away.</p>
                </div>
                <div className="p-4 bg-white/5 rounded-xl">
                  <div className="flex items-center mb-2">
                  ...
                  <p className="text-white/70 text-sm">Stand up and stretch every hour to maintain energy levels.</p>
                </div>
                <div className="p-4 bg-white/5 rounded-xl">
                  <div className="flex items-center mb-2">
                  ...
                  <p className="text-white/70 text-sm">Avoid screens 1 hour before bedtime for better sleep quality.</p>
                </div>
              </div>
            </div>
          </div>
